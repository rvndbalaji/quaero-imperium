        ...
        return (
            <Row>
                <Col lg='auto' md='auto' sm='auto'>                    
                    <Button size='sm' variant='info' disabled={(props.selected_row.OBJECT_TYPE==='FILE'?false:true)}>                                        
                            <FaRegFileAlt className='mb-1'/>
                            <span style={{whiteSpace : 'pre'}}>  File Columns</span>                    
                    </Button>    
                </Col>                
                <Col lg='auto' md='auto' sm='auto'>                    
                <Button size='sm' variant='info' disabled={(props.selected_row.OBJECT_TYPE==='TABLE'?false:true)}>                                        
