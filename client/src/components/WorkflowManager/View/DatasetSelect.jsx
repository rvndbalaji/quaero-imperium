        ...
        return (
            <Row>
                <Col lg='auto' md='auto' sm='auto'>                    
                    <Button size='sm' variant='info' disabled={(props.selected_row.OBJECT_TYPE==='FILE'?true:true)} style={{opacity:0}}>                                        
                            <FaRegFileAlt className='mb-1'/>
                            <span style={{whiteSpace : 'pre'}}>  File Columns</span>                    
                    </Button>    
                </Col>                
                <Col lg='auto' md='auto' sm='auto'>                    
                <Button size='sm' variant='info' disabled={(props.selected_row.OBJECT_TYPE==='TABLE'?true:true)} style={{opacity:0}}>                                        
