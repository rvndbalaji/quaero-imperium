    ...
    render() {
        ...
        {            
            ...
            let ViewWorkflowButton = (<Col lg='auto' md='auto'>                            
                                    <Link to={'/wf_man/view/' + workflow.AUTH_TYPE + '/' + ((workflow.SQL_UN)?workflow.SQL_UN:'win') + '/'+ ((workflow.ENCRYPT)?workflow.ENCRYPT:0) + '/'+ workflow.SERVER_NAME + '/' + workflow.METASTORE_NAME + '/' + workflow.WORKFLOW_ID} target='_blank'>
